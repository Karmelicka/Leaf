...
public class ExplorationMapFunction extends LootItemConditionalFunction {
    ...
    public static final Codec<ExplorationMapFunction> CODEC = RecordCodecBuilder.create((instance) -> {
        return commonFields(instance).and(instance.group(ExtraCodecs.strictOptionalField(TagKey.codec(Registries.STRUCTURE), "destination", DEFAULT_DESTINATION).forGetter((function) -> {
            return function.destination;
        }), MapDecoration.Type.CODEC.optionalFieldOf("decoration", DEFAULT_DECORATION).forGetter((function) -> {
            return function.mapDecoration;
        }), ExtraCodecs.strictOptionalField(Codec.BYTE, "zoom", (byte)2).forGetter((function) -> {
            return function.zoom;
        }), ExtraCodecs.strictOptionalField(Codec.INT, "search_radius", 50).forGetter((function) -> {
            return function.searchRadius;
        }), ExtraCodecs.strictOptionalField(Codec.BOOL, "skip_existing_chunks", true).forGetter((function) -> {
            return function.skipKnownStructures;
