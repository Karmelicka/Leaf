...
public abstract class AbstractArrow extends Projectile {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> type, Level world, ItemStack stack) {
        super(type, world);
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> type, LivingEntity owner, Level world, ItemStack stack) {
