...
public class Arrow extends AbstractArrow {
    ...
    public Arrow(EntityType<? extends Arrow> type, Level world) {
        super(type, world, Arrow.DEFAULT_ARROW_STACK);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public Arrow(Level world, double x, double y, double z, ItemStack stack) {
        super(EntityType.ARROW, x, y, z, world, stack);
        this.potion = Potions.EMPTY;
        this.effects = Sets.newHashSet();
    }

    public Arrow(Level world, LivingEntity owner, ItemStack stack) {
