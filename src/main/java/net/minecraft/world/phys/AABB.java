...
public class AABB {
    ...
    public static AABB encapsulatingFullBlocks(BlockPos pos1, BlockPos pos2) {
        return new AABB((double)Math.min(pos1.getX(), pos2.getX()), (double)Math.min(pos1.getY(), pos2.getY()), (double)Math.min(pos1.getZ(), pos2.getZ()), (double)(Math.max(pos1.getX(), pos2.getX()) + 1), (double)(Math.max(pos1.getY(), pos2.getY()) + 1), (double)(Math.max(pos1.getZ(), pos2.getZ()) + 1));
    }
