...
public class Mth {
    ...
    public static int hsvToRgb(float hue, float saturation, float value) {
        ...
        return FastColor.ARGB32.color(0, clamp((int)(k * 255.0F), 0, 255), clamp((int)(l * 255.0F), 0, 255), clamp((int)(m * 255.0F), 0, 255));
    }
    ...
    public static double wobble(double d) {
        return d + (2.0D * RandomSource.create((long)floor(d * 3000.0D)).nextDouble() - 1.0D) * 1.0E-7D / 2.0D;
    }
